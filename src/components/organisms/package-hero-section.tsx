// src/components/organisms/paket-wisata/package-hero-section.tsx
  ...
  return (
    <section className="mb-10">
      ...
      <div className="flex items-start justify-between gap-4 mb-2">
        <div>
          <h1 className="text-2xl font-bold text-[#0B2C4D]">{paket.name}</h1>
        ...
        <div className="flex flex-col items-end gap-3 shrink-0">
          <div className="text-right">
            <p className="text-2xl font-bold text-[#F36F21]">Rp. {Number(paket.price_per_person).toLocaleString('id-ID')}</p>
            <p className="text-sm text-gray-500">/ Orang</p>
          </div>
          <a
            href={`https://wa.me/6285861556201?text=Halo, saya tertarik dengan ${encodeURIComponent(paket.name)}`}
            target="_blank"
